...
export default class BaseQuizScene extends Phaser.Scene {    constructor(config) {
    ...
    getScaleFactor() {
        ...
        this.currentQuestionStartTime = 0;
        this.maxComboReached = 0;
        this.difficulty = data.difficulty || 'medium'; // Get difficulty from data// Define available enemy sprites (only include existing files)
    ...
    handleTimeUp() {
        ...
        this.time.delayedCall(1000, () => {
            // If this is the last question, calculate and award points before victory
